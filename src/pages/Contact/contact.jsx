    ...
    return (
        <div>
            ...
            <section className="contactPage">
                <MDBRow className="contactRow col-lg-8 col-md-12">
                    ...
                    <MDBCol className="contInq col-12 col-lg-4 col-md-4 ">
                    ...
                    <MDBCol className="emailForm col-12 col-lg-8 col-md-8">
                        <div className="container">
                            <div>
                                <form ref={form} onSubmit={sendEmail}>
                                    ...
                                    <div className="subtmitBtn col-12">
